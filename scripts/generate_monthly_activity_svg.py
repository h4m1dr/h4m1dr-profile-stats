...
def main() -> None:
    """Generate a placeholder SVG for monthly activity."""
    svg_content = """
<svg xmlns="http://www.w3.org/2000/svg" width="600" height="80">
  ...
  <text x="20" y="30" class="title">Monthly Activity</text>
...
""".strip()
    ...
    print(f"[INFO] Wrote placeholder monthly activity SVG to: {output_path}")
